...
[ISO 3166 1-qism, ikki harfli kodlar](ValueSet-iso-3166-2-vs.html) va [O'zbekistonsiz](ValueSet-iso-3166-2-vs-sans-uz.html) qiymatlar to'plamlari endi [ISO 3166 qo'shimchasini](CodeSystem-iso3166-two-letter-cs.html) `valueset-supplement` orqali majburiy deb e'lon qilmaydi. Majburiy qo'shimcha faqat asosiy kod tizimi mahalliy yuklangan yoki qiymatlar to'plami allaqachon kengaytirilgan bo'lsa qo'llanilishi mumkin; `urn:iso:std:iso:3166` faqat terminologiya serverida mavjud, bog'liq paketdagi qiymatlar to'plami esa hech qachon kengaytirilmaydi, shuning uchun validatorlar ushbu to'plamlarga bog'langan har bir nusxani `Required supplement not found` xatosi bilan rad etardi. Muammo uz.dhp.integrations dagi `example-hepatitis-patient` da IG Publisher 2.3.4 ostida namoyon bo'ldi - u ilgari buni yashirib kelgan NullPointerException ni tuzatdi. Qo'shimchaning o'zi o'zgarmagan va terminologiya serveriga yuborilishda davom etadi, shuning uchun o'zbek va rus tilidagi belgilashlar qo'llanilishda davom etadi.
